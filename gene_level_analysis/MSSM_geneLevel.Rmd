---
title: Covariate and differential expression analysis of MSSM reprocessed counts
...
The [markdown](https://www.synapse.org/#!Synapse:syn8484987) produced for this publication is available on Synapse with files linked via Provenance. 
...
COUNT <- synapser::synGet(COUNT_ID, version = 1)$path %>%
...
METADATA_TECH <- synapser::synGet(METADATA_TECH_ID, version = 7)$path %>%
...
Genes that are differentially expressed at an FDR <= 0.05 and fold change of 1.2 are
...
all.annotations$normalizationType	= 'CQN'
...
COUNT_OBJ = synStore(COUNT_OBJ, activity = synapseClient::synGetActivity(COV_OBJ$properties$id))
...
ECOUNT_OBJ = synStore(ECOUNT_OBJ, activity = synapseClient::synGetActivity(COV_OBJ$properties$id))
...
LCOUNT_OBJ = synStore(LCOUNT_OBJ, activity = synapseClient::synGetActivity(COV_OBJ$properties$id))
...
all.annotations@annotations@stringAnnotations$dataSubType = 'offset'
annotations(OFFSET_OBJ) = all.annotations
OFFSET_OBJ = synStore(OFFSET_OBJ, activity = synapseClient::synGetActivity(COV_OBJ$properties$id))
...
DM_OBJ = synStore(DM_OBJ, activity = synapseClient::synGetActivity(COV_OBJ$properties$id))
...
SURR_OBJ = synStore(SURR_OBJ, activity = synapseClient::synGetActivity(COV_OBJ$properties$id))
...
eEXP_OBJ = synStore(eEXP_OBJ, activity = synapseClient::synGetActivity(COV_OBJ$properties$id))
...
nEXP_OBJ = synStore(nEXP_OBJ, activity = synapseClient::synGetActivity(COV_OBJ$properties$id))
...
DEXP_OBJ = synStore(DEXP_OBJ, activity = synapseClient::synGetActivity(COV_OBJ$properties$id))
...
FIT_OBJ = synStore(FIT_OBJ, activity = synapseClient::synGetActivity(COV_OBJ$properties$id))
