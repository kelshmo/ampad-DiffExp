...
# Estimate voom weights for dispersion control
VOOM.WEIGHTS = voom(cnts[,rownames(DESIGN$design)], design=DESIGN$design, plot=F)
...
all.annotations@annotations@stringAnnotations$normalizationType	= 'CQN'
...
knit2synapse::knitToFolderEntity(file = "./ROSMAP_geneLevel.Rmd",
                                 parentId = "syn8672910",
