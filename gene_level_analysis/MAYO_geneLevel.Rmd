...
#https://www.tidyverse.org/articles/2019/03/tibble-2.1.1/
...
|  *Results*                                  |  *File Name*                                 |
|  -----------------------------------------  |   ---------                                  |
|  Covariates                                 |  MAYO_CBE_TCX_Covariates.tsv                 |
|  Counts (raw)                               |  MAYO_CBE_TCX_Counts.tsv                     |
|  Counts (estimated)                         |  MAYO_CBE_TCX_eCounts.tsv                    |
|  Counts (lcpm)                              |  MAYO_CBE_TCX_logCPM.tsv                     |
|  Offset (for gene length and gc content)    |  MAYO_CBE_TCX_offset.tsv                     |
|  Design Matrix                              |  MAYO_CBE_TCX_Design.tsv                     |
|  Surrogate Variables                        |  MAYO_CBE_TCX_SurVar.tsv                     |
|  Residual Expression (for eQTL)             |  MAYO_CBE_TCX_eQTLResidualExpression.tsv     |
|  Residual Expression (for network analysis) |  MAYO_CBE_TCX_netResidualExpression.tsv      |
|  Differential Expression                    |  MAYO_CBE_TCX_DiffExpression.tsv             |
|  All model fits                             |  MAYO_CBE_TCX_allfits.RData                  |
